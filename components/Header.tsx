...
export function Header() {
  ...
  return (
    <header
      ...
      `}
    >
      <nav className="mx-auto max-w-content px-6 lg:px-nav-x">
        <div className="flex h-16 lg:h-20 items-center justify-between">
          ...
          <ul className="hidden lg:flex items-center gap-10">
            {navigation.map((item) => (
              <li key={item.name}>
                <Link
                  href={item.href}
                  className="text-nav text-neutral-600 hover:text-neutral-900 transition-colors"
                >
                  {item.name}
                </Link>
              </li>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/subscribe"
              className="hidden sm:inline-flex px-5 py-2.5 bg-neutral-900 text-white text-body-sm font-medium rounded-md hover:bg-neutral-800 transition-colors"
            >
              Subscribe
            </Link>
